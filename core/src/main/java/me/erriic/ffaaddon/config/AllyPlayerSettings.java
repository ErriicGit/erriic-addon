...
public class AllyPlayerSettings extends Config {
  @ParentSwitch
  @SpriteSlot(x = 7)
  @SwitchSetting
  ...
  @SpriteSlot(x = 1, y = 1)
  @ColorPickerSetting(alpha = true)
  private ConfigProperty<Integer> fill = new ConfigProperty<>(new Color(0, 255, 0, 100).getRGB());

  @SpriteSlot(x = 2, y = 1)
  @ColorPickerSetting(alpha = true)
  private ConfigProperty<Integer> tab = new ConfigProperty<>(new Color(0, 255, 0, 100).getRGB());
